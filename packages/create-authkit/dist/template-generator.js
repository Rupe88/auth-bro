...
export { router as apiRouter };`,
        'src/middleware/auth.ts': `import { AuthKit } from '@rupeshe/auth-bro';
import { PrismaClient } from '@prisma/client';
...
export const apiRoutes = {};`,
  ...
  "devDependencies": {
    ...
    "eslint-config-next": "^14.0.0"
        ...
        'src/app/api/auth/[...nextauth]/route.ts': `import { AuthKit } from '@rupeshe/auth-bro';
import { PrismaClient } from '@prisma/client';
...
export async function generateTemplate(projectPath, config, projectName) {
